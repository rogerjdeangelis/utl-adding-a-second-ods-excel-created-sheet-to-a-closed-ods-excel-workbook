...
'd:/xls/odsXlsAddReport.xlsx' # destination's fullpath                             ") VALUES("$xl = new-object -c excel.application  
VALUES("$wb1 = $xl.workbooks.open($file1, $null, $true) # open source, readonly ") VALUES("$wb2 = $xl.workbooks.open($file2) # open t
VALUES("$sheetToCopy = $wb1.sheets.item('male') # source sheet to copy") VALUES("$sheetToCopy.copy($sh1_wb2) # copy source sheet to d
